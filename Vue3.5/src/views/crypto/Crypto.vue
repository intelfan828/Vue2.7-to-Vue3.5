    ...
    <v-container fluid grid-list-xl pt-0>
      <div class="crypto-dash-wrap">
        ...
        <v-layout row wrap border-rad-sm overflow-hidden>
          <stats-card-v7
            colClasses="xl3 lg3 md3 sm6 xs12 crypto-stats-card"
        ...
        <v-layout row wrap>
          <!-- Trade History-->
          <v-col xl8 lg8 md12 sm12 xs12 pa-0>
            <app-card
              colClasses="xl12 lg12 md12 sm12 xs12"
            ...
            <v-layout row wrap crypto-row-mrgn>
              <v-col xs12 sm12 md7 lg7 pa-0>
                <!--Exchange Statistics -->
                <app-card
                  colClasses="xl12 lg12 md12 sm12 xs12"
          ...
          <v-col xs12 sm12 md12 lg4 xl4 pa-0>
            <!-- Safe Trade -->
            <app-card
              colClasses="xl12 lg12 md12 sm12 xs12"
              customClasses="mb-0"
