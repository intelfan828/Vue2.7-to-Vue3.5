    ...
    <div class="top-selling-widget">
      <slick :options="slickOptions">
        <div v-for="(item, index) in exchangeStatistic" :key="index">
          <v-layout row wrap>
            <v-col xl-7 lg7 md8 sm8 xs12 mb-4>
            ...
            <v-col xl-5 lg5 md4 sm4 xs8 mb-4>
              <div>
                ...
                <div class="crypto-result-price">
                  <div class="d-custom-flex justify-space-between">
                    <span class="fw-bold">Price:</span> <span>{{ item.price }}</span>
                  </div>
                  <div class="d-custom-flex justify-space-between">
                    <span class="fw-bold">Volume:</span><span>{{ item.volume }}</span>
                  </div>
