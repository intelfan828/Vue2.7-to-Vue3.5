  ...
  <div>
    ...
    <v-container fluid grid-list-xl pt-0>
      ...
      <v-layout row wrap>
        ...
        <app-card :heading="$t('message.editableNumericValue')" colClasses="xs12 md6">
          <v-responsive
            height="100px"
            v-bind:style="{ background: `rgb(${red}, ${green}, ${blue})` }"
          ></v-responsive>
          <v-layout row wrap>
            <v-col xs9>
      ...
      <v-layout row wrap>
        <app-card :heading="$t('message.icons')" colClasses="xs12 md6">
          <v-layout row wrap>
            <v-col xs4>
