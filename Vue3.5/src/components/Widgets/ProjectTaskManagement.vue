<template>
  <div>
    <PerfectScrollbar style="height: 622px" :settings="settings">
      <v-list>
        <template v-for="(tasks, taskkey, index) in projectTaskData" :key="taskkey">
          <v-list-item>
            ...
            <v-list class="project-list-item list-aqua-ripple">
              <v-list-item
                v-for="(items, index) in tasks.length"
              ...
              <v-form v-model="valid" :key="index">
                <div class="add-project d-custom-flex justify-space-between align-center">
                  ...
                  <div class="button-wrap">
                    ...
                    <v-btn @click="collapse()" color="error" small class="mb-0 mt-2 d-block">
                      Cancel
                    </v-btn>
                  </div>
                </div>
