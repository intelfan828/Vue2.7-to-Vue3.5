...
<template>
  <div class="device-share-wrap">
    <div class="mb-2 pos-relative">
      <doughnut-chart-v2 :chartH="240" :config="devicesShare"> </doughnut-chart-v2>
    ...
    <div class="hidden-xs-only">
      <div class="d-custom-flex widget-footer">
        <div class="fs-12 fw-normal grey--text">
          ...
          <span class="d-block"
            >{{ Math.round((this.devices.web / this.devices.total) * 100) }} %</span
          >
        ...
        <div class="fs-12 fw-normal grey--text">
          ...
          <span class="d-block"
            >{{ Math.round((this.devices.ios / this.devices.total) * 100) }} %</span
          >
        ...
        <div class="fs-12 fw-normal grey--text">
          ...
          <span class="d-block"
            >{{ Math.round((this.devices.android / this.devices.total) * 100) }} %</span
          >
