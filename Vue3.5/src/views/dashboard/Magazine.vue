<template>
  <div>
    <v-container fluid class="stats-wrap">
      <v-layout row wrap class="magazine-stats-wrap mx-0">
        <v-col xl3 lg3 md3 sm6 xs12>
          <stats-card-v5
    ...
    <v-container fluid grid-list-xl pt-0>
      ...
      <v-layout row wrap>
        ...
        <app-card :fullBlock="true" colClasses="xl6 lg6 md6 xs12 sm12">
      ...
      <v-layout row wrap>
        ...
        <app-card colClasses="xl4 lg4 md4 xs12 sm6 col-height-auto" customClasses="height-auto">
