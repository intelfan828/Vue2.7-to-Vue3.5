          ...
          <v-col cols="12" sm="9" md="10" lg="10" class="mx-auto">
            <v-row>
                ...
                <div class="product-images-wrap d-flex">
                  <div class="product-images mr-4">
                    <div class="thumb-wrap ml-auto">
                      <v-img
                        class="mb-6"
                        v-for="(img, i) in selectedProduct.image_gallery"
                        :src="img"
              ...
              <v-col cols="12" sm="12" md="6" lg="6" class="content-wrap pl-md-6">
                ...
                >
                <p class="mb-3 fs-14 text-gray-light">
                  <span class="fw-semi-bold text-gray">Name :</span> {{ selectedProduct.name }}
                </p>
                <p class="mb-3 fs-14 text-gray-light">
                  <span class="fw-semi-bold text-gray">Price :</span> {{ selectedProduct.price }}
                </p>
                <p class="mb-3 fs-14 text-gray-light">
                  <span class="fw-semi-bold text-gray">Availability :</span>
                  {{ selectedProduct.availablity }}
                </p>
                <p class="mb-3 fs-14 text-gray-light">
                  <span class="fw-semi-bold text-gray">Product Code :</span>
                  {{ selectedProduct.product_code }}
                </p>
                <p class="mb-3 fs-14 text-gray-light">
                  <span class="fw-semi-bold text-gray">Tags :</span> {{ selectedProduct.tags }}
                </p>
                <p class="mb-3 fs-14 text-gray-light">
                  <span class="fw-semi-bold text-gray">Description :</span>
                  {{ selectedProduct.description }}
                </p>
                <p class="mb-3 fs-14 text-gray-light">
                  <span class="fw-semi-bold text-gray">Features :</span>
