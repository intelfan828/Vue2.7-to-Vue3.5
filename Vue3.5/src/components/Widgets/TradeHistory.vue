  ...
  <div>
    <v-card text>
      <div class="table-responsive trade-history-table">
        ...
        <v-data-table :headers="headers" :items="tradeHistory" :items-per-page="5">
                ...
                <div class="d-flex align-items-center">
                  <v-dialog max-width="500px">
                    <template v-slot:activator="{ on }">
                      <v-btn text icon color="grey" small @click="on" class="my-3 mx-2">
                        ...
                        <v-container grid-list-md>
                          <v-layout wrap>
                            <v-container xs12>
                              ...
                              <p>
                                Transaction with Txn No 76237523 was placed on 21/3/102, 11:10 with
                                Payment done being
                              </p>
                              <p>Successful.</p>
                              <table>
