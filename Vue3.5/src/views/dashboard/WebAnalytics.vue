  ...
  <div>
    ...
    <v-container fluid grid-list-xl>
      <v-layout row wrap class="stats-card-v4">
        <v-col xl4 lg4 md4 sm4 xs12 b-50>
          <stats-card-v4
      ...
      <v-layout row wrap>
        ...
        >
          ...
          <span
            class="grey--text d-custom-flex align-items-center justify-content-end"
            slot="footer"
          >
      ...
      <v-layout row wrap>
        <app-card colClasses="xl6 lg6 md6 sm6 xs12" contentCustomClass="pb-0 px-0">
          <bandwidth-usage-v2></bandwidth-usage-v2>
        </app-card>
        <app-card contentCustomClass="pb-0 px-0" colClasses="xl6 lg6 md6 sm6 xs12">
      ...
      <v-layout row wrap>
        <v-col class="xl3 lg3 md6 sm6 xs6 stats-widget-v3">
          <stats-card-v3
            icon="bookmark"
      ...
      <v-layout row wrap>
        ...
        <v-col class="xl6 lg6 md6 xs12 sm12">
          <v-layout row wrap>
            <v-col class="xl6 lg6 md6 sm6 xs12 d-block">
              <users-stat></users-stat>
            </v-col>
            <v-col class="xl6 lg6 md6 xs12 sm6 d-block">
      ...
      <v-layout row wrap>
        <v-col class="xl6 lg6 md6 sm12 xs12">
