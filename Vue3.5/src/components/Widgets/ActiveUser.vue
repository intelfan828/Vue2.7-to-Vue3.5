...
<template>
  <div>
    <div class="app-card-title info white--text d-block py-5">
    ...
    <PerfectScrollbar style="height: 375px" :settings="settings" class="active-user">
      <ul class="pl-0 list-group-flush list-unstyled">
        <li v-for="activeUser in data" :key="activeUser.id" class="d-flex px-4 align-center">
          <div class="d-custom-flex align-items-center w-50">
            <div class="flag-img mr-4">
              <img
                :src="`/static/flag-icons/${activeUser.flag}.png`"
                alt="flag-img"
