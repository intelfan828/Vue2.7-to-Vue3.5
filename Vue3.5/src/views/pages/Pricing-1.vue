          ...
          <div>
            <div class="pricing-wrapper">
              <div class="pricing-top mb-70">
                <v-layout row wrap>
                  <v-col xs12 md9 lg7 mx-auto text-center pa-0>
              ...
              <div class="pricing-list">
                ...
                <div class="fixed-pricing">
                  <v-layout row wrap row-eq-height>
                    <v-col xs12 sm4 md4 lg4 pr-0 w-full>
                      <div class="pricing-box">
                        <div class="pricing-head">
                          <h2 class="primary--text pricing-title mb-0">
                            {{ $t('message.basicFree') }}
                          </h2>
                        </div>
                        <div class="plan-info">
                        ...
                        <div class="pricing-body">
                          ...
                          <v-btn color="primary" large block>{{
                            $t('message.startToBasic')
                          }}</v-btn>
                        </div>
                      </div>
                    </v-col>
                    <v-col xs12 sm4 md4 lg4 px-0 w-full>
                      <div class="pricing-box">
                        <div class="pricing-head">
                        ...
                        <div class="pricing-body">
                          ...
                          <v-btn color="warning" large block>{{
                            $t('message.upgradeToPro')
                          }}</v-btn>
                        </div>
                      </div>
                    </v-col>
                    <v-col xs12 sm4 md4 lg4 pl-0 w-full>
                      <div class="pricing-box">
                        <div class="pricing-head">
                          <h2 class="success--text pricing-title mb-0">
                            {{ $t('message.advanced') }}
                          </h2>
                        </div>
                        <div class="plan-info">
