<template>
  <v-expansion-panels v-model="panel">
    <v-expansion-panel v-for="(data, index) in walletData" :key="index" expand-icon="mdi-menu-down">
      ...
      <v-expansion-panel-content>
        <v-container fluid grid-list-xl>
          <v-layout row wrap align-items-center colClasses="xl6 lg6 md6 sm12 xs12">
            <v-col d-flex xs12 sm7 md7>
              <div>
                <div class="mb-4">
                ...
                <v-btn class="primary ml-0">Withdraw</v-btn>
                <v-btn class="info m-0 ml-4">Deposit</v-btn>
              </div>
            </v-col>

            <v-col d-flex xs12 sm5 md5>
              <div>
