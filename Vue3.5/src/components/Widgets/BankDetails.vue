            ...
            <div class="mb-4">
              <h5>
                <span class="fw-normal"
                  ><i class="zmdi zmdi-balance primary--text mr-3 font-lg"></i>Central Bank Of
                  Lorem</span
                >
              </h5>
              <h6>
                <span class="success--text"
                  ><i class="zmdi zmdi-check success--text mr-3 font-lg"></i>KYC Verified</span
                >
              </h6>
            </div>
          </div>
