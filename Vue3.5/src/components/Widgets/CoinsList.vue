  ...
  <div>
    <v-card flat>
      <div class="table-responsive">
        ...
        <div class="mb-6">
          <v-btn @click="changeBtn('BTC')" :class="{ primary: isBtc }"> BTC </v-btn>
          <v-btn @click="changeBtn('ETH')" :class="{ primary: isEth }"> ETH </v-btn>
          <v-btn @click="changeBtn('EUR')" :class="{ primary: isEur }"> EUR </v-btn>
        </div>
