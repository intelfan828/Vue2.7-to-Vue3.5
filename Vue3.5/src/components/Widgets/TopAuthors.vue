<template>
  <div>
    <div class="primary pos-relative white--text pt-5">
    ...
    <slick :options="slickOptions" v-if="authors">
      <div v-for="author in authors" :key="author.id" class="author-detail-wrap">
        <div class="author-avatar primary pos-relative mb-50">
          <div class="avatar-img">
            <img
              :src="author.avatar"
              width="87"
              height="87"
              class="img-responsive mx-auto rounded-circle"
            />
          </div>
        </div>
        <div class="pa-4 authors-info">
          <h5>{{ author.name }}</h5>
          <ul class="pl-0 list-unstyled author-contact-info mb-3">
            <li>
              <span class="mr-3"><i class="zmdi zmdi-phone-msg"></i></span>
              <a href="tel:123456" class="fs-12 grey--text fw-normal">{{
                author.profileInfo.phone
              }}</a>
            </li>
            <li>
              <span class="mr-3"><i class="zmdi zmdi-email"></i></span>
              <a href="mailto:joan_parisian@gmail.com" class="fs-12 grey--text fw-normal">{{
                author.profileInfo.email
              }}</a>
            </li>
            <li>
          ...
          <ul class="pl-0 d-custom-flex social-info list-unstyled">
            <li>
              <a class="facebook" :href="author.socialLinks.facebookUrl"
                ><i class="zmdi zmdi-facebook-box"></i
              ></a>
            </li>
            <li>
              <a class="twitter" :href="author.socialLinks.twitterUrl"
                ><i class="zmdi zmdi-twitter-box"></i
              ></a>
            </li>
            <li>
              <a class="linkedin" :href="author.socialLinks.linkedinUrl"
                ><i class="zmdi zmdi-linkedin-box"></i
              ></a>
            </li>
            <li>
              <a class="instagram" :href="author.socialLinks.instagramUrl"
