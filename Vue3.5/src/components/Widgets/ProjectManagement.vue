<template>
  <div class="project-management">
    ...
    <PerfectScrollbar style="height: 636px" :settings="settings">
      <div class="v-table__overflow">
        <table class="v-datatable v-table v-datatable--select-all theme--light">
          ...
          <tbody>
            <template v-for="(data, index) in projectData" :key="index">
              <tr>
                <td>{{ data.name }}</td>
                ...
                <td>
                  <div class="justify-space-between d-custom-flex align-center">
                    ...
                    <v-btn v-if="data.collapseStatus" @click="expand(data)" text icon>
                      <i class="zmdi zmdi-minus-circle font-lg grey--text"></i>
                    </v-btn>
                    <v-btn v-else @click="expand(data)" text icon>
