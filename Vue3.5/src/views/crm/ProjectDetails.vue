  ...
  <div>
    ...
    <v-container fluid pt-0 grid-list-xl>
      <div v-if="selectedManagement !== null">
        ...
        <v-layout row wrap>
          <app-card colClasses="xl8 lg8 md12 sm12 xs12" customClasses="mb-0">
            <!-- Description Details -->
          ...
          <!--selectedProject -->
          <app-card colClasses="xl4 lg4 md12 sm12 xs12">
        ...
        <v-layout row wrap>
          ...
          <!-- Progress Bar -->
          <app-card colClasses="xl4 lg4 md4 sm6 xs12">
            <div class="mb-5">
        ...
        <v-layout row wrap>
          ...
          <!-- Project Gallery -->
          <app-card :heading="$t('message.projectGallery')" colClasses="xl4 lg4 md4 sm6 xs12">
