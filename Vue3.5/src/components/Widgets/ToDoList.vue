  ...
  <div>
        ...
        <v-list-item v-for="(item, index) in toDoLists" :key="index" href="javascript:;" ripple>
          <v-list-item-action>
            <v-checkbox
              ...
              @click.stop="marked(item)"
            ></v-checkbox>
          </v-list-item-action>
          <template @click="marked(item)">
    ...
    <v-dialog v-model="dialog" max-width="500px">
      <template v-slot:activator="{ on }">
        <v-btn color="primary" small @click="on" class="mx-4 my-4">
              ...
              <v-col xs12>
                ...
                >
                  ...
                  <v-date-picker v-model="newToDo.date" no-title scrollable>
                    ...
                    <v-btn color="warning" @click="$refs.menu.save(newToDo.date)">{{
                      $t('message.ok')
                    }}</v-btn>
                  </v-date-picker>
                </v-menu>
