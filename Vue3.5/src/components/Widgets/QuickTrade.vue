<template>
  <div>
    <v-tabs class="quicktrade-tab-wrap" v-model="active" slider-color="primary">
      <v-tab v-for="(tab, index) in tabs" :key="index" ripple :value="index">
      ...
      <v-tabs-window-item :value="1">
        <v-card flat>
          <div>
            ...
            <div class="mb-5">
              <v-text-field label="Select Amount" value="200" type="number" min="1"></v-text-field>
            </div>
            <div class="mb-5">
              <v-text-field
      ...
      <v-tabs-window-item :value="2">
        <v-card flat>
          <div>
            ...
            <div class="mb-5">
              <v-text-field label="Select Amount" value="300" type="number" min="1"></v-text-field>
            </div>
            <div class="mb-5">
              <v-text-field
                :append-icon="showPassword ? 'visibility' : 'visibility_off'"
