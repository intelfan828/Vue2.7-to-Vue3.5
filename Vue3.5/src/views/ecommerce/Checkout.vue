    ...
    <v-container fluid pt-0>
      <app-card :fullBlock="true">
        <v-layout row wrap px-3>
          <v-col xs12 sm12 xl8 lg6 md6 class="col-height-auto px-6">
            ...
            <div>
              ...
              <v-layout row wrap>
                <v-col xs12 sm12 md12 xl12 lg12 mb-5 class="col-height-auto">
                  <v-checkbox
                    v-model="addressCheck"
                    label="Shipping address is the same as billing address."
                    value=""
                  ></v-checkbox>
                  <span class="error--text fs-12 d-block fw-normal"
          ...
          <v-col xs12 sm12 xl4 lg6 md6 border-left-1 class="px-6">
            <div class="py-6">
